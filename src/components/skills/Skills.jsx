      ...
      <div className="container flex flex-wrap px-5 py-24 mx-auto items-center">
        ...
        >
          ...
          <div
            data-aos="fade-right"
            data-aos-delay="500"
            className="flex flex-wrap mb-4 text-gray-300"
          >
            <p>
              HTML | CSS | Tailwind CSS | JavaScript | React | TypeScript |
              Chakra UI | Next.js | Redux
            </p>
          </div>
          <h5
            data-aos="fade-right"
          ...
          <div
            data-aos="fade-right"
            data-aos-delay="500"
            className="flex flex-wrap mb-8 text-gray-300"
          >
        ...
        <div className="flex flex-col md:w-1/2 md:pl-12">
          <nav
            className="grid grid-cols-4 sm:grid-cols-3 gap-6"
          >
            <li
              data-aos="fade-left"
              data-aos-delay="500"
