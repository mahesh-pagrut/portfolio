...
export default function Projects() {
    const listProjects = [
        { id: 1, image: image, title: 'MavericksCV', description: 'MavericksCV is a React-based single-page application tagged as the ultimate resume builder. It uses the Harvard letter format to create CVs and is designed to be user-friendly and efficient.', liveLink: 'https://mavericks-cv.netlify.app/' },
        { id: 2, image: image2, title: 'Project 2', description: 'Photo description for project', liveLink: 'https://mavericks-cv.netlify.app/' },
        { id: 3, image: image3, title: 'Project 3', description: 'Photo description for project', liveLink: 'https://mavericks-cv.netlify.app/' },
        { id: 4, image: image4, title: 'Project 4', description: 'Photo description for project', liveLink: 'https://mavericks-cv.netlify.app/' },
    ];
